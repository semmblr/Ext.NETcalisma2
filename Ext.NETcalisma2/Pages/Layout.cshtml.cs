...
namespace Ext.NETcalisma2.Pages
{
    public class LayoutModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            string url = @"https://localhost:44336/api/Category";
            var request = (HttpWebRequest)WebRequest.Create(url);
            //kaynağın URI 'siyle çağırarak bir örnek oluşturun.

            //Çağırarak isteği sunucuya gönderin WebRequest.GetResponse . 
            //Bu yöntem, sunucunun yanıtını içeren bir nesne döndürür. 
            //Döndürülen WebResponse nesnenin türü, isteğin URI 'si düzenine göre belirlenir.
            ...
            //Sunucu tarafından gönderilen yanıt verilerini içeren akışı almak için
            ...
            List<Categories> items1 = JsonConvert.DeserializeObject<List<Categories>>(html);
            List<object> items = new List<object>();

            foreach (var item in items1)

            {
                items.Add(new object[] {item.CategoryName, item.Description});
